...
type Method = 'reference' | 'password'
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-8 shadow-sm">
        ...
        >
          <button
            type="button"
            role="tab"
            aria-selected={method === 'reference'}
            onClick={() => switchMethod('reference')}
            className={
              method === 'reference'
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          {method === 'reference' ? (
            <div>
              <label className="block text-sm font-medium text-slate-700" htmlFor="booking-reference">
                Booking reference
              </label>
              <input
