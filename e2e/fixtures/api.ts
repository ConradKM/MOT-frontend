...
function defaults(): Stub[] {
  return [
    ...
    { match: (u) => u.pathname === '/api/appointment-type-groups/', handler: (r) => json(r, APPOINTMENT_TYPE_GROUPS) },
    { match: (u) => u.pathname === '/api/booking-flow/sections', handler: (r) => json(r, FLOW_SECTIONS) },
